      ...
      <div class="contentBx">
        <div class="formBx">
          ...
          <form @submit.prevent="login">
            <div v-if="errors && errors.match" class="text-danger">
              {{ errors.match[0] }}
            </div>
            <div class="inputBx">
              <span>البريد الالكتروني</span>
              <input type="text" name="" v-model="fields.email" />
    ...
    login() {
      axios
        ...
        .then((response) => {
          ...
          console.log(token);
          localStorage.setItem("design-store-token", token);
...
section .sectionBx .welcomeBx h3 {
  color: gray;
  font-weight: 600;
  margin-right: 0.8rem;
  font-size: 1.2em;
...
@media (max-width: 768px) {
  ...
  section .sectionBx .contentBx .formBx {
    width: 60%;
    padding: 50px;
